...
<section class="events archive section">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-3 col-12">
                <div class="section-title bg">
                    <h2> رفتاروآداب</h2>
                    <p>این بخش برای آشنایی بیشتر شما با آداب ، رفتار ، فرهنگ و.. انگلیسی زبانان است .</p>
        ...
        <div class="row">
            ...
            // کوئری برای دریافت رفتاروآداب از دیتابیس
            $sql = "SELECT id, title, content, created_at, Picture FROM culture";
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="single-event" style="height: 400px;">
                            ...
                            <div class="event-content">
                                <h3 class="event-title"><a href="culture.php?id=<?php echo $row["id"]; ?>"><?php echo $row["title"]; ?></a></h3>
