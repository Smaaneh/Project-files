				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-12">
						<ul class="bread-list">
							...
							<li class="active"><a href="#">انیمیشن ها</a></li>
						</ul>
					</div>
				</div>
			</div>
...
$sql = "SELECT Title, caption, Video FROM movie WHERE Collection_name = 'Animation'";
...
if ($result->num_rows > 0) {
    ...
    echo "هنوز فیلم انیمیشن در این سایت بارگذاری نشد ه است لطفا از بقیه بخش های سایت استفاده کنید";
}
