...
// دریافت اطلاعات از جدول grammar
...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">گرامر</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <a class="btn btn-success btn-lg" href="addgrammer.php">افزودن گرامر جدید +</a>
                    <div class="card-header">
                        <h3 class="card-title">لیست کل گرامرها</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
