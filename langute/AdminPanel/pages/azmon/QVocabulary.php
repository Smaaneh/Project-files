...
<head>
  ...
  <title>مدیریت | سوالات واژگان</title>
...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <a class="btn btn-success btn-lg" href="addQVocabulary.php">افزودن سوال جدید +</a>
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td><a href='editQVocabulary.php?question_id=" . $row['question_id'] . "' class='btn btn-block btn-info btn-sm'>ویرایش</a></td>";
                                        echo "<td><button data-url='deleteQVocabulary.php?id=" . $row['question_id'] . "' class='btn btn-danger btn-sm' onclick='confirmDelete(" . $row['question_id'] . ");'>حذف</button></td>";
                                        echo "</tr>";
                                    }
                                } else {
...
<script>
    function confirmDelete(id) {
        ...
        if (result) {
            // اگر کاربر تایید کرد، ارسال درخواست حذف به صفحه deleteQVocabulary.php
            window.location.href = "deleteQVocabulary.php?id=" + id;
        } else {
