                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-left">
                                ...
                                <li class="breadcrumb-item"><a href="QConversation.php">سوالات مکالمه</a></li>
                                <li class="breadcrumb-item active">ویرایش سوالات مکالمه</li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($conn->query($update_sql) === TRUE) {
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<script>window.location.href = 'QConversation.php';</script>";
                } else {
