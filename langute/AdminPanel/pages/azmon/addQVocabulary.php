          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item"><a href="QVocabulary.php">سوالات واژگان</a></li>
                <li class="breadcrumb-item active">افزودن سوالات واژگان</li>
              </ol>
            </div>
          </div>
        </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // استخراج اطلاعات سوالات واژگان به دیتابیس
    $sql = "INSERT INTO questions (category, question_title) VALUES ('Vocabulary', '$questionTitle')";
...
<div class="container">
    <div class="col-lg-6 offset-lg-3 col-12">
        ...
        <?php endif; ?>
        <form action="addQVocabulary.php" method="post">
