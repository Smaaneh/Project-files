...
$sql = "SELECT * FROM songs WHERE Collection_name = 'Motivational'";
...
<head>
        ...
        <!-- Title -->
        <title>پادکست های انگیزشی</title>
        <!-- songs -->
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-12">
						<ul class="bread-list">
                            ...
                            <li class="active"><a href="#">پادکست های انگیزشی<i class="fa fa-angle-left"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
