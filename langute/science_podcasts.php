...
$sql = "SELECT * FROM songs WHERE Collection_name = 'Academic'";
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-12">
						<ul class="bread-list">
                            ...
                            <li class="active"><a href="#">پادکست های علمی<i class="fa fa-angle-left"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
