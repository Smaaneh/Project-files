...
$sql = "SELECT * FROM book WHERE collection_name = 'Romance'";
    ...
    <div class="row">
     ...
     <div class="col-lg-6 col-md-6 col-12">
      <ul class="bread-list">
       ...
       <li class="active"><a href="#">کتاب های عاشقانه <i class="fa fa-angle-left"></i></a></li>
      </ul>
     </div>
    </div>
   </div>
